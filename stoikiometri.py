...
if (page =='HUBUNGAN PERSEN B/B DAN B/V'):
    ...
    with tab1:
        ...
        st.image ('images/beratpervolume.png')
...
if (page =='PENGENCERAN DALAM TITRIMETRI'):
    ...
    with tab1:
        ...
        if (selected =='perhitungan pengenceran'):
            ...
            st.image ('images/pengenceran.png')
